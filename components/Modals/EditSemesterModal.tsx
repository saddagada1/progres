import {
  ...
  const EditSemesterModal: React.FC<EditSemesterModalProps> = ({
    ...
    useEffect(() => {
      setName(semester.semestername);
      setIcon(semester.semestericon);
      semester.semesterusecalculatedgpa === 1
        ? setUseCalculatedGpa(true)
        : setUseCalculatedGpa(false);
      semester.semestersetgpa
        ? setGpa(semester.semestersetgpa.toString())
        : setGpa("");
    ...
    return (
      ...
      >
        <Text style={styles.header}>Edit Semester</Text>
